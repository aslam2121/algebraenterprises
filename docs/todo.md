...
- If property detail metadata ever looks incomplete again, check the public detail page for new fields that need to be rendered explicitly; `Property_Type`, `Available_Floors`, and `Features` are now shown there
