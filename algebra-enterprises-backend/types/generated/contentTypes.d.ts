...
export interface ApiEnquiryEnquiry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Client_Status: Schema.Attribute.Enumeration<['New', 'Contacted', 'Closed']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Email: Schema.Attribute.Email;
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Agent_Phone: Schema.Attribute.String;
    Area_Acre: Schema.Attribute.Decimal;
    Area_sqft: Schema.Attribute.Decimal;
    Area_Sqm: Schema.Attribute.Decimal;
    Assigned_Agent: Schema.Attribute.Relation<
      'manyToOne',
